...
public class PutFigureStep extends BaseTutorialStep implements ITutorialStep {

	private List<Class> tutorialActions;
	private TutorialConfig tutorialConfig;

	@Inject
	public PutFigureStep(TutorialConfig tutorialConfig) {
	...
	public GameField getField() {
		...
		figure1.setPosition(3, 3);
		Figure figure2 = new Figure(FigureTypes.cross);
		figure2.setPosition(3, 5);
