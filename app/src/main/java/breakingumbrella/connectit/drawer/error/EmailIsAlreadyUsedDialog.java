...
public class EmailIsAlreadyUsedDialog extends BlurDialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		((TextView)v.findViewById(R.id.lbTitle)).setText(v.getContext().getString(R.string.emailIsUsed));
		((TextView)v.findViewById(R.id.lbErrorMessage)).setVisibility(View.GONE);
		((TextView)v.findViewById(R.id.lbErrorCauseBy)).setVisibility(View.GONE);
		return v;
	}
